...
namespace GTA
{
	...
	public ref class CEF sealed abstract
	{
	public:
		static array<Native::OutputArgument^> ^GetEventTriggerParams();
		static void LoadURL(System::String ^url);
		static void Focus(bool value);
		//static void ExecuteJavaScript(System::String ^code);
		//static void ShowCursor(bool value);
		//static void KeyHandler(bool value);
	private:
