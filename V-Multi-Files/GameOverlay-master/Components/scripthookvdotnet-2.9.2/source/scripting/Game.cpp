...
namespace GTA
{
	...
	void Game::RevealFullMap(bool state)
	{
		Native::MemoryAccess::RevealFullMap(state, false);
	}

	System::String ^Game::Location()
	{
	...
	{
		Native::MemoryAccess::SlowMo();
	}

	void Game::UnlockAllObjects()
	{
		//Native::MemoryAccess::UnlockAllObjects();
	}
