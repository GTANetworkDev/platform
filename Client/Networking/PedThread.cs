...
namespace GTANetwork.Networking
{
    public class PedThread : Script
    {
        ...
        public static void OnTick(object sender, EventArgs e)
        {
            ...
            Util.Util.DrawText("CurrentStreamedPlayers: " + StreamedPlayers + "", 600, 880, 0.5f, 255, 255, 255, 255, 0, 1, false, true, 0);
            Util.Util.DrawText("CurrentStreamedPlayersInRange: " + StreamedPlayersInRange + "", 920, 40, 0.5f, 255, 255, 255, 255, 0, 1, false, true, 0);
