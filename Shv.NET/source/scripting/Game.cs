...
namespace GTA
{
	...
	public static class Game
	{
        ...
        {
            return IsControlPressed(control) && !IsControlEnabled(control);
        }
        /// <summary>
        ...
        {
            return IsControlJustPressed(control) && !IsControlEnabled(control);
        }
        /// <summary>
        ...
        {
            return IsControlJustReleased(control) && !IsControlEnabled(control);
        }
        /// <summary>
